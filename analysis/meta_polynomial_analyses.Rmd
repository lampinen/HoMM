...
result_subdirs = c("basic_ADAM_nobinary_slower", "untrained_baseline", "nometa_fastrun")
language_result_subdirs = c("language_meta_only")
language_only_subdirs = c("language_coeff_only") # missing other losses
